...
Sample: emailContacts_Mendocino('OWNER APPLICANT', 'DPD_WAITING_FOR_PAYMENT'); //minimal
        emailContacts_Mendocino('OWNER APPLICANT,BUSINESS OWNER', 'DPD_PERMIT_ISSUED', eParamHashtable, 'Construction Permit', rParamHashtable, 'Y', 'New Report Name'); //full
 */
function emailContacts_Mendocino(sendEmailToContactTypes, emailTemplate, vEParams, reportTemplate, vRParams) {
