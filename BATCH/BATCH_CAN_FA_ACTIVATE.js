/*------------------------------------------------------------------------------------------------------/
| Program: BATCH_CAN_FA_ACTIVATE.js  Trigger: Batch
        ...
        else
        {
            ...
            for (var j in recArray)
            {
                ...
                if (cap)
                {
                    ...
                    var open = lookup("CAN_NOF_CONTROLS", "NOF Affidavit Window Open Date")+"";
                    var close = lookup("CAN_NOF_CONTROLS", "NOF Affidavit Window Close Date")+"";
                    var year = lookup("CAN_NOF_CONTROLS", "Calendar Year")+"";
                        ...
                        if (contactResult.getSuccess()) {
                            ...
                            for (var i in capContacts) {
                                ...
                                if(hm[capContacts[i].getPeople().getEmail() + ""] != 1) {
                                    sendEmail("no-reply@mendocinocounty.org", capContacts[i].getPeople().getEmail() + "", "", "CAN_NOF_SECOND_AFFIDAVIT", params, null, capId);
