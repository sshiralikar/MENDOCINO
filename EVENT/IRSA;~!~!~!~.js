...
if (appMatch("Cannabis/*/Application/NA")) {
    if ((inspType == "Cultivation - Site Inspection" ||
        inspType == "Cultivation - Special Inspection" ||
        inspType == "Nursery - Site Inspection" ||
        inspType == "Nursery - Special Inspection") && (inspResult == "Pass" || inspResult == "Fail")) {
