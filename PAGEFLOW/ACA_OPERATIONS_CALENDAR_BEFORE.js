/*------------------------------------------------------------------------------------------------------/
| Program : ACA_OPERATIONS_CALENDAR_BEFORE.js
...
try {
    ...
    if (rows != 12 || operationsCounter == 0 || !operationsCalendar) {
        showMessage = true;
        comment("All 12 Months must be populated, if there isn't any activity in a month, please indicate with No Activity.");
        cancel = true;
    }
