...
function handleExpirations()
{
    ...
    else
    {
        ...
        for (var j in recArray)
        {
            ...
            var expObj = new Date(newExpDate);
            var today = new Date();
            const diffTime =expObj - today;
            ...
            if(parseInt(diffDays) < 0)
            {
                ...
                if(balance == 0){
                    ...
                    aa.print("Expired: "+ capIDString+" - Exp Date: "+ expDate);
                }
                else
                {
                    aa.print("Expired Permit with Balance: "+ capIDString+" - Exp Date: "+ expDate);
                }
                var test = true;
            ...
            else if(parseInt(diffDays)> 0 && parseInt(diffDays) <= 90)
            {
                var hm = new Array();
                aa.print("About to Expire: "+ capIDString+" - Exp Date: "+ expDate);
